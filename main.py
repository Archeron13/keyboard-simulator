...
class StartGUI:
    ...
    def __init__(self):
        ...
        self.last_index_of_list = 70  # End index of shown list
        ...
        self.inputTextLabel = ctk.CTkLabel(self.root, text=self.input_var, text_font=("Arial50", "15"),
    ...
    def start_game(self):
        if not self.game_running:
            self.name = tkinter.simpledialog.askstring("Name", "Please enter your name!", parent=self.root)
    ...
    def start_game_thread(self):
        ...
        while True:
            ...
            save_score = False
            if self.not_saved:
                save_score = tkinter.messagebox.askyesno("Save score", "Would you like to save your score?")
            ...
            if save_score:
                ...
                with open("score.txt", "a+") as file:
                    ...
                    score = self.correct_count / self.total_counter * 100 * (self.correct_count / self.time_taken * 60)
